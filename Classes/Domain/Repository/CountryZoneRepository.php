...
/**
 * Description of CountryZoneRepository
 *
 * @author Markus Pircher
 */
class CountryZoneRepository extends \SJBR\StaticInfoTables\Domain\Repository\CountryZoneRepository {

    public function findByIsoCodeA3($isocode) {
        $query = $this->createQuery();
        $and = array(
            //$query->equals('zn_country_iso_3', $isocode)
            $query->equals('zn_country_iso_3', $isocode)
        );
